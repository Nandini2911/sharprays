...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "There is no universal website development timeline.\n\nProject duration depends on factors such as page count, design requirements, custom functionality, content readiness, integrations, feedback cycles and stakeholder approvals.\n\nThe expected project timeline is defined after the scope is understood.",
  },
  {
    question: "How much does a business website cost?",
    answer:
      "Website development pricing depends on the complexity of the project.\n\nFactors can include strategy, number of unique pages, design requirements, functionality, integrations, CMS needs, content support and ongoing maintenance.\n\nWe define the project scope before confirming commercial terms.",
  },
  {
    question: "Who provides the website content?",
    answer:
      "Content responsibilities are confirmed during project planning.\n\nYour team may provide final content, Sharp Rays may support the content process, or responsibilities may be shared depending on the proposal.",
  },
  {
    question: "Do you provide website maintenance after launch?",
    answer:
      "Ongoing support and maintenance can be discussed separately depending on the website and your internal requirements.\n\nThe final proposal confirms what is included after launch.",
  },
  {
    question: "Can a new website improve conversions?",
    answer:
      "A better website can remove friction, improve clarity and create stronger pathways towards important actions.\n\nHowever, conversion performance also depends on factors such as traffic quality, offer, pricing, market demand, messaging and sales process.\n\nWe avoid promising conversion improvements that cannot be supported by real data.",
  },
  {
    question:
      "Can a website help with AI Overviews and AI search visibility?",
    answer:
      "A well-structured website can make your information easier for search systems to crawl and understand.\n\nClear content, original expertise, logical page relationships and strong technical SEO can support overall search eligibility.\n\nThere is no development technique that guarantees inclusion in an AI Overview or other generative answer.",
  },
];
          ...
          >
            ...
            <span
              className="
                ...
                shadow-[0_9px_25px_rgba(11,42,82,0.17)]
              "
            >
            ...
            <div className="flex-1">
              ...
              <p
                ...
                "
              >
                Clear scope, thoughtful design and development decisions built
                around what your website actually needs to accomplish.
              </p>
            </div>
