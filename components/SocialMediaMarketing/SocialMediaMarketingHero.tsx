...
export default function SocialMediaMarketingHero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[720px] max-w-[1500px] items-center px-5 py-24 sm:min-h-[760px] sm:px-8 md:py-28 lg:min-h-screen lg:px-12 lg:py-20 xl:px-16">
        <div className="grid w-full items-center lg:grid-cols-[0.88fr_1.12fr] xl:grid-cols-[0.84fr_1.16fr]">
          {/* =====================================================
              LEFT CONTENT
          ====================================================== */}
...
>
  Your Brand Shouldn't Just Be Seen.
...
>
  It Should Be Remembered
            ...
            >
              Strategic content, engaging communities and data-driven social
              media marketing that turns attention into meaningful
...
>
  ...
  <span className="relative z-10">
   See Our Approach
          ...
          <div
            className={`relative mt-12 flex min-h-[390px] items-center justify-center transition-all duration-[1400ms] lg:mt-0 lg:min-h-[600px] ${
              isVisible
          ...
          >
            ...
            >
              <img
                ...
                className="relative z-10 mx-auto h-auto w-full object-contain object-center drop-shadow-[0_35px_65px_rgba(11,42,82,0.10)] transition-transform duration-[1400ms] hover:scale-[1.015]"
              />
            </div>
      ...
      >
        ...
        <ArrowDown
          size={11}
          className="animate-bounce text-[#B79A72]"
        />
      </div>
    </section>
  );
